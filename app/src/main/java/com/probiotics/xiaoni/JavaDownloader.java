...
public final class JavaDownloader {
    ...
    private static final String USER_AGENT = "Android 16; PMA120 Build/BP2A.250605.015";
    ...
    private static final int XIAOMI_CONNECTIONS = 16;
    private static final int OPLUS_CONNECTIONS = 4;
    private static final int OPLUS_DOWNGRADE_CONNECTIONS = 16;
    private static final long XIAOMI_SEGMENT_BYTES = 8L * 1024 * 1024;
